...
---
# Introduction
Intro text about data sets, team member contributions.
...
inclusionary <- inclusionary %>%
  st_transform(CA_zone_3)
```
# Average Number of Projects with Inclusionary Requirements in Planning Districts
```{r}
planning <- planning %>%
...
```
Text here about what the map says.


# Average distance of Projects with Inclusionary Requirements from Rental Buyouts
```{r, results = FALSE, message = FALSE}
inclusionary <- inclusionary %>%
